 ...
 */
     ...
     */
         ...
         *
         * @return \App\Infrastructure\Laravel\Kernel\Console
         * @static
         *@internal
         */
        public static function rerouteSymfonyCommandEvents()
        {            //Method inherited from \Illuminate\Foundation\Console\Kernel
                        /** @var \App\Infrastructure\Laravel\Kernel\Console $instance */
     ...
     */
         ...
         *
         * @return \App\Infrastructure\Laravel\Models\User|null
         * @static
         */
         ...
         *
         * @param mixed $id
         * @return \App\Infrastructure\Laravel\Models\User|false
         * @static
         */
         ...
         *
         * @return \App\Infrastructure\Laravel\Models\User
         * @static
         */
...
')
    ...
    namespace App\Domain\User\Authentication\Requests {
            /**
     *
     *
     */
    ...
    namespace App\Domain\User\Profile\Requests {
            /**
     *
     *
     */
...
use Illuminate\Contracts\Support\DeferringDisplayableValue;use Illuminate\Contracts\Support\Htmlable;use Illuminate\Support\Arr;use Illuminate\Support\Env;use Illuminate\Support\HigherOrderTapProxy;use Illuminate\Support\Optional;use Illuminate\Support\Sleep;use Illuminate\Support\Str;
